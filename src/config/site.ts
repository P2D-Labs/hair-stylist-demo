      ...
      services: [
        {
          ...
          price: "LKR 6,500",
          duration: "60 min",
          description: "A precision cut shaped to your face and texture, finished with a full blow-dry style.",
        },
        {
          name: "Restyle Consultation & Cut",
          price: "LKR 9,000",
          duration: "90 min",
          description: "An in-depth consultation for anyone changing direction, followed by the cut itself.",
        },
        {
          name: "Blow-dry & Style",
          price: "LKR 4,000",
          duration: "45 min",
          description: "A polished finish for everyday wear or ahead of a big night out.",
        },
        {
          name: "Special Occasion Styling",
          price: "LKR 7,500",
          duration: "60 min",
          description: "Elevated styling for weddings, events, and photoshoots, built to last the day.",
        },
        {
          name: "Men's Cut",
          price: "LKR 4,500",
          duration: "40 min",
          description: "A sharp, low-maintenance cut tailored to your hair type and routine.",
        },
      ],
    },
    {
      ...
      services: [
        {
          ...
          price: "LKR 18,500",
          duration: "3 hr",
          description: "Hand-painted, dimensional color for a natural, sun-kissed grow-out.",
        },
        {
          name: "Root Touch-Up",
          price: "LKR 8,500",
          duration: "90 min",
          description: "A seamless color match at the root to refresh your existing shade.",
        },
        {
          name: "Global Color",
          price: "LKR 14,000",
          duration: "2 hr",
          description: "All-over single-process color for full, even coverage.",
        },
        {
          name: "Fashion / Fantasy Color",
          price: "from LKR 16,000",
          duration: "3 hr",
          description: "Bold, statement shades customized to your vision, from pastels to vivids.",
        },
        {
          name: "Toner & Gloss",
          price: "LKR 5,500",
          duration: "45 min",
          description: "A quick refresh that neutralizes brassiness and adds shine between color visits.",
        },
      ],
    },
    {
      ...
      services: [
        {
          name: "Bond Rebuild Treatment",
          price: "LKR 8,000",
          duration: "45 min",
          description: "Rebuilds internal hair bonds broken down by heat, color, or chemical services.",
        },
        {
          name: "Scalp Therapy",
          price: "LKR 6,000",
          duration: "40 min",
          description: "A restorative scalp massage and treatment to support healthy hair growth.",
        },
        {
          name: "Keratin Smoothing",
          price: "LKR 22,000",
          duration: "3 hr",
          description: "A smoothing treatment that softens frizz and cuts down on styling time for months.",
        },
        {
          name: "Deep Conditioning Ritual",
          price: "LKR 5,000",
          duration: "30 min",
          description: "An intensive moisture treatment that restores softness and shine.",
        },
      ],
    },
    {
      ...
      services: [
        {
          name: "Perm / Texturizing",
          price: "from LKR 12,000",
          duration: "2.5 hr",
          description: "Lasting curl or volume, customized in size and pattern to suit your hair.",
        },
        {
          name: "Tape-In Extensions",
          price: "from LKR 28,000",
          duration: "2 hr",
          description: "Seamless length and fullness using premium tape-in wefts.",
        },
        {
          name: "Braiding & Updo",
          price: "from LKR 6,000",
          duration: "60 min",
          description: "Intricate braiding or updo styling for events and special occasions.",
        },
      ],
    },
  ],
